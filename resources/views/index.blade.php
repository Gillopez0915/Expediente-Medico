...
<body class="theme-red">
    ...
    @section('script')
        ...
        {{Html::script('bsbmd/plugins/jquery-redirect/jquery.redirect.js')}}
        ...
        {{Html::script('bsbmd/js/pages/Search/typeahead.bundle.js')}}
    @show
    @yield('extra-script')
    @section('script-bottom')
        ...
        @routes
        {{Html::script('bsbmd/js/pages/Search/buscaPaciente.js')}}
